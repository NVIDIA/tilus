...
class TestTcgen05SmemLayout:
    ...
    def test_mn_major_32b_swizzle_layout(self):
        ...
        canonical = CanonicalSharedLayout(
            shape=(16, 24), major_kind="MN", swizzle_mode=Tcgen05SwizzleMode.B32_SWIZZLE, sbo=16, lbo=8, m=2, k=3, t=4
        )
    ...
    def test_mn_major_64b_swizzle_layout(self):
        ...
        canonical = CanonicalSharedLayout(
            shape=(16, 16), major_kind="MN", swizzle_mode=Tcgen05SwizzleMode.B64_SWIZZLE, sbo=16, lbo=8, m=1, k=2, t=4
        )
    ...
    def test_mn_major_128b_swizzle_layout(self):
        ...
        canonical = CanonicalSharedLayout(
            shape=(16, 16), major_kind="MN", swizzle_mode=Tcgen05SwizzleMode.B128_SWIZZLE, sbo=16, lbo=8, m=1, k=2, t=2
        )
    ...
    def test_k_major_no_swizzle_layout(self):
        ...
        canonical = CanonicalSharedLayout(
            shape=(16, 12), major_kind="K", swizzle_mode=Tcgen05SwizzleMode.NO_SWIZZLE, sbo=16, lbo=8, m=2, k=3, t=4
        )
    ...
    def test_k_major_32b_swizzle_layout(self):
        ...
        canonical = CanonicalSharedLayout(
            shape=(16, 24), major_kind="K", swizzle_mode=Tcgen05SwizzleMode.B32_SWIZZLE, sbo=16, lbo=8, m=2, k=3, t=4
        )
    ...
    def test_k_major_64b_swizzle_layout(self):
        ...
        canonical = CanonicalSharedLayout(
            shape=(16, 32), major_kind="K", swizzle_mode=Tcgen05SwizzleMode.B64_SWIZZLE, sbo=16, lbo=8, m=2, k=2, t=4
        )
    ...
    def test_k_major_128b_swizzle_layout(self):
        ...
        canonical = CanonicalSharedLayout(
            shape=(16, 32), major_kind="K", swizzle_mode=Tcgen05SwizzleMode.B128_SWIZZLE, sbo=16, lbo=8, m=2, k=2, t=2
        )
    ...
    def test_coordinate_mapping(self):
        ...
        mn_canonical = CanonicalSharedLayout(
            shape=(8, 24), major_kind="MN", swizzle_mode=Tcgen05SwizzleMode.NO_SWIZZLE, sbo=16, lbo=8, m=2, k=3, t=4
        )
    ...
    def test_swizzle_transformation_difference(self):
        ...
        no_swizzle_canonical = CanonicalSharedLayout(
            shape=(8, 24), major_kind="MN", swizzle_mode=Tcgen05SwizzleMode.NO_SWIZZLE, sbo=1, lbo=1, m=1, k=1, t=4
        )

        swizzled_canonical = CanonicalSharedLayout(
            shape=(8, 8), major_kind="MN", swizzle_mode=Tcgen05SwizzleMode.B32_SWIZZLE, sbo=1, lbo=1, m=1, k=1, t=4
        )
    ...
    def test_different_parameter_combinations(self):
        ...
        for major_kind, t, m, k, sbo, lbo, swizzle_mode in test_cases:
            ...
            canonical = CanonicalSharedLayout(
                shape=expected_shape, major_kind=major_kind, swizzle_mode=swizzle_mode, sbo=sbo, lbo=lbo, m=m, k=k, t=t
            )
...
class TestCanonicalizeSharedLayout:
    ...
    def test_roundtrip_k_major_64b_swizzle(self):
        ...
        original_canonical = CanonicalSharedLayout(
            shape=(8, 16), major_kind="K", swizzle_mode=Tcgen05SwizzleMode.B64_SWIZZLE, sbo=1, lbo=1, m=1, k=1, t=4
        )
        ...
        recovered_offset = vectorized_evaluate(
            recovered_layout.offset, {axis: grid[i] for i, axis in enumerate(recovered_layout.axes)}
        )
