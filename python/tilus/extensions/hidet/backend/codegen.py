...
from hidet.ir.expr import Expr, Constant, Var
from hidet.ir.module import IRModule
from hidet.ir.target import Target
from hidet.ir.func import Function
from hidet.ir.type import DataType, PointerType, TensorPointerType, ReferenceType, TensorType, ArrayType, OpaqueType
...
class UpdatedCUDACodeGen(CUDACodegen):
    def param_declare_v2(self, func_kind: str, v: Var):
        v_type = v.type
        name_doc = self(v)
