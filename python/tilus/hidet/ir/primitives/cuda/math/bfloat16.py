...
# See the License for the specific language governing permissions and
# limitations under the License.
from tilus.hidet.ir.dtypes import bfloat16, float32
...
class CUDABFloat16MathFunctionSet(MathFunctionSet):
    ...
    def tanh(self, a: Expr) -> Expr:
        ...
        from tilus.hidet.ir.primitives.math import tanh
    ...
    def erf(self, a: Expr) -> Expr:
        ...
        from tilus.hidet.ir.expr import cast
        from tilus.hidet.ir.primitives.math import erf
    ...
    def pow(self, a: Expr, b: Expr) -> Expr:
        ...
        from tilus.hidet.ir.expr import cast
        from tilus.hidet.ir.primitives.math import pow
