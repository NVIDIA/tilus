...
# limitations under the License.
"""
Doc utilities for pretty-printing code/IR.

This module merges the Doc/Text/NewLine classes from hidet/utils/doc.py with the
extension helpers (doc_join, doc_join_lines, doc_comment, doc_strip_parentheses)
from tilus/extensions/hidet/utils/doc.py.
"""
...
class Text(Doc):
    ...
    def format(self, *args: object) -> Doc:
...
def doc_strip_parentheses(doc: Doc, left_paren: str = "(", right_paren: str = ")") -> Doc:
    """Strip parentheses around a doc.

    Strip when there exists a pair of parentheses at the beginning and the end of the doc.
    ...
    left_paren: str
        The left parentheses to strip.
    right_paren: str
        The right parentheses to strip.
